...
},
{
 ...
 {error && <p className="p-2 text-center text-red-500 border-2 my-4">{error}</p>}
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-800 py-2 font-medium transition hover:bg-gray-50 text-gray-800"
        >
          <FaGoogle size={18} />
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <button onClick={()=>{setshowSignup(true)}} className="font-medium text-blue-600 hover:underline cursor-pointer">
            Register
          </button>
        </p>
      </div>
